...
class JModel
{
	...
	{
		$Adapter=get_class(Jf::$Db);
		return $Adapter == "mysqli" or $Adapter == "CI_DB_mysqli_driver" or ($Adapter == "PDO" and Jf::$Db->getAttribute(PDO::ATTR_DRIVER_NAME)=="mysql");
	}
}
...
abstract class BaseRbac extends JModel
{
	...
	public function pathId($Path)
	{
		...
		$Adapter = get_class(Jf::$Db);
		if ($Adapter == "mysqli" or $Adapter == "CI_DB_mysqli_driver" or ($Adapter == "PDO" and Jf::$Db->getAttribute(PDO::ATTR_DRIVER_NAME)=="mysql")) {
